...
#+begin_src emacs-lisp
  ...
  (use-package general
    ...
    (owl/leader-keys
      ...
      "cf" '(lambda () (interactive) (find-file (expand-file-name "~/Workspaces/Personal/dotfiles/Emacs/Emacs.org")) :which-key "Configuration File")))
...
#+begin_src emacs-lisp
  ...
  (owl/leader-keys 
    ...
    "bb" '(ivy-switch-buffer t :which-key "Find Buffer")
    "bd" '(kill-buffer t :which-key "Kill Buffer")
    )

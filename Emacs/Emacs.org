  ...
  (use-package elfeed
    ...
    (setq elfeed-feeds
          '(
            ...
            ;; Engineering 
            ("https://martinfowler.com/feed.atom" engineering)
            ("https://rubyonrails.org/feed.xml" engineering ruby)
            ("https://lore.kernel.org/lkml/new.atom" engineering kernel)
            ;; Podcasts
            ("https://feeds.feedburner.com/AkitaOnRails?format=xml" podcast))))

...
#+begin_src emacs-lisp
  ...
  (torresmo/leader-keys
    "ag" '(:ignore t :which-key "Gptel")
    "agc" '(gptel :which-key "Chat")
    "agf" '(gptel-add-file :which-key "Add file")
...
#+begin_src emacs-lisp
  ...
  (torresmo/leader-keys
    "aa" '(:ignore t :which-key "Aider")
    "aac" '(aider-run-aider :which-key "Chat")
    "aam" '(aider-transient-menu :which-key "Menu")
    )

...
#define DE_LGUI &kp LGUI   // Command (left)
#define DE_RGUI &kp RGUI   // Command (right)
...
#define DE_SLSH &kp INT1       // / (ABNT2 extra key — HID INT1 no macOS)
...
#define DE_QMARK &kp LS(INT1)   // ? (ABNT2 extra key — HID INT1 no macOS)
